...
// if (rear == front)
// {
// cout<<"\n\n __ Currently queue is Overflowed ! __";
// return;
// }
if (front == -1)
{
...
cout<<" > 1. VIEW RECORDS\t> 2. ENQUEUE RECORDS\t> 3. DEQUEUE RECORD\t> 4.
...
{
cout<<"\n\n __ Currently queue is Full ! __\n Please dequeue to get a empty
spot\n";
break;
}
case 3:
...
{
cout<<"\n\n __ Currently queue is Empty ! __";
break;
}
else
{
